...
void Interface::drawWall( float position)
{
    sf::Vertex line[] =
    {
            ...
            sf::Vertex(sf::Vector2f(position, GameHight-250), ballFillColor)
            };
...
void Interface::drawBullseyes(Vector2D PositBullseyes, float Radius) {
   ...
   rectangle.setPosition(PositBullseyes.x, PositBullseyes.y);
    rectangle.setFillColor(sf::Color::Blue);
    window.draw(rectangle);
  */

      /*  sf::CircleShape octagon(Radius, 8);
        octagon.setPosition(PositBullseyes.x, PositBullseyes.y);
        octagon.setFillColor(sf::Color::Blue);
        window.draw(octagon);
    */
    sf::CircleShape drawBullseyes(Radius);
    drawBullseyes.setOrigin(Radius, Radius);
    drawBullseyes.setPosition(PositBullseyes.x, PositBullseyes.y);
    drawBullseyes.setFillColor(sf::Color::Blue);
    window.draw(drawBullseyes);
}
...
void Interface::drawlanes(Vector2D line1start, Vector2D line1end) {
    sf::Vertex line1[] =
    {
            sf::Vertex(sf::Vector2f(line1start.x , line1start.y), ballFillColor),
            sf::Vertex(sf::Vector2f(line1start.x , line1start.y+100), ballFillColor)
    };
    sf::Vertex line2[] =
    {
            sf::Vertex(sf::Vector2f(line1end.x , line1end.y), ballFillColor),
            sf::Vertex(sf::Vector2f(line1end.x , line1end.y+100), ballFillColor)
    };
